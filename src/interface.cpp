...
DNN_ver()
{
    return Rcpp::wrap(DNN::internal::DNN_ver());
}
...
mlp_construct(SEXP lays)
{
    ...
    try {
        DNN::internal::mlp_construct(layers, n_p, n_prev, n_next,
                                      w_p, w_val, w_fl, w_on);
                          ...
                          SEXP nn, SEXP m)
{
    ...
    try {
        DNN::internal::mlp_expand_reorder_inputs(layers, n_p, n_prev, n_next,
               ...
               SEXP a, SEXP ap, SEXP reprt)
{
    ...
    int nrm = DNN::internal::mlp_rm_neurons(layers, n_p, n_prev, n_next,
                                             w_p, w_val, w_fl, w_on,
                                             af, af_p,
                                             report);
                     ...
                     SEXP wp, SEXP wval, SEXP wfl, SEXP reprt)
{
    ...
    DNN::internal::mlp_rm_input_neurons(layers, n_p, n_prev, n_next,
          ...
          SEXP sinp)
{
    ...
    try {
        DNN::internal::mlp_merge(Alayers, Aw_p, Aw_val, Aw_fl,
          ...
          SEXP Blays, SEXP Bwp, SEXP Bwval, SEXP Bwfl)
{
    ...
    try {
        DNN::internal::mlp_stack(Alayers, Aw_p, Aw_val, Aw_fl,
                                  Blayers, Bw_p, Bw_val, Bw_fl,
                                  layers, n_p, n_prev, n_next,
                                  w_p, w_val, w_fl, w_on);
    } catch (DNN::exception &e) {
...
mlp_import(SEXP fname)
{
    ...
    if (!DNN::internal::mlp_load_txt(fn,
                                      netname,
                                      layers, n_p, n_prev, n_next,
                                      w_p, w_val, w_fl, w_on,
                                      af, af_p)) {
           ...
           SEXP a, SEXP ap)
{
    ...
    return Rcpp::wrap(DNN::internal::mlp_save_txt(fn,
             ...
             SEXP A, SEXP b, SEXP C, SEXP d, SEXP E, SEXP f)
{
    ...
    try {
        return Rcpp::wrap(DNN::internal::mlp_export_C(fn,
...
mlp_get_abs_w_idx(SEXP wfl, SEXP idx)
{
    ...
    for (int i = 0; i < ii.size(); ++i) {
        ai[i] = DNN::internal::mlp_get_abs_w_idx(w_fl, ii[i]);
    }
    return Rcpp::wrap(ai);
}
...
{
    for (int n = 0; n < *N; ++n) {
        DNN::internal::mlp_set_active(layers, n_p, n_prev, n_next,
                                    w_p, w_val, w_fl, w_on,
                                    i[n], on[n]);
    }
}
...
{
    return Rcpp::wrap(DNN::internal::mlp_act_f_str(Rcpp::as<int>(idx)));
}
...
{
    DNN::internal::eval(lays, *no_lays, n_pts,
                         w_val, af, af_p,
                         *no_datarows, in, out);
}
...
mlp_mse(const int *lays, const int *no_lays, const int *n_pts,
        ...
        double *res)
{
    *res = DNN::internal::mse(lays, *no_lays, n_pts,
                               w_val, af, af_p,
                               *no_datarows, in, out);
}
...
{
    try {
        double mse = DNN::internal::grad(lays, *no_lays, n_pts,
                                        w_pts, w_fl, w_val,
                                        af, af_p,
...
{
    try {
        DNN::internal::gradi(lays, *no_lays, n_pts,
                            w_pts, w_fl, w_val,
                            af, af_p,
...
{
    try {
        DNN::internal::gradij(lays, *no_lays, n_pts,
...
{
    try {
        DNN::internal::jacob(lays, *no_lays, n_pts,
                              w_pts, w_fl, w_val, *no_w_on,
                              af, af_p,
...
{
    DNN::internal::ihessupdate(*nw, *no, *a, g, H);
}
