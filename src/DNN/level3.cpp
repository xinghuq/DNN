...
template <typename T>
void
DNN::internal::eval(const int *lays, int no_lays, const int *n_pts,
...
template <typename T>
T
DNN::internal::mse(const int *lays, int no_lays, const int *n_pts,
                    const T *w_val, const int *af, const T *af_p,
...
template <typename T>
T
DNN::internal::grad(const int *lays, int no_lays, const int *n_pts,
...
template <typename T>
void
DNN::internal::gradi(const int *lays, int no_lays, const int *n_pts,
                      const int *w_pts, const int *w_fl, const T *w_val,
                      const int *af, const T *af_p,
...
template <typename T>
void
DNN::internal::gradij(const int *lays, int no_lays, const int *n_pts,
...
template <typename T>
void
DNN::internal::jacob(const int *lays, int no_lays, const int *n_pts,
                      const int *w_pts, const int *w_fl, const T *w_val, int no_w_on,
                      const int *af, const T *af_p,
...
template <typename T>
void
DNN::internal::ihessupdate(int nw, int no, T a, const T *g, T *H)
{
    std::vector<T> HXv(nw);
    T *HX = &HXv[0];
    const T *X = g;
...
#if !defined(DNN_DOUBLE_ONLY)
template void DNN::internal::eval(const int*, int, const int*,
                                   const float*, const int*, const float*,
                                   int, const float*, float*);
template float DNN::internal::mse(const int*, int, const int*,
                                   const float*, const int*, const float*,
                                   int, const float*, const float*);
template float DNN::internal::grad(const int*, int, const int*,
                                    const int*, const int*, const float*,
                                    const int*, const float*,
                                    int, const float*, const float*, float*);
template void DNN::internal::gradi(const int*, int, const int*,
                                    const int*, const int*, const float*,
                                    const int*, const float*,
                                    int, int, const float*, const float*, float*);
template void DNN::internal::gradij(const int*, int, const int*,
                                     const int*, const int*, const float*, int,
                                     const int*, const float*,
                                     int, int, const float*, float*);
template void DNN::internal::jacob(const int*, int, const int*,
                                    const int*, const int*, const float*, int,
                                    const int*, const float*,
                                    int, int, const float*, float*);
#if defined(HAVE_BLAS)
template void DNN::internal::ihessupdate(int, int, float, const float*, float*);
#endif /* defined(HAVE_BLAS) */
#endif /* !defined(DNN_DOUBLE_ONLY) */
template void DNN::internal::eval(const int*, int, const int*,
                                   const double*, const int*, const double*,
                                   int, const double*, double*);
template double DNN::internal::mse(const int*, int, const int*,
                                    const double*, const int*, const double*,
                                    int, const double*, const double*);
template double DNN::internal::grad(const int*, int, const int*,
...
template void DNN::internal::jacob(const int*, int, const int*,
                                    ...
                                    int, int, const double*, double*);
#if defined(HAVE_BLAS)
template void DNN::internal::ihessupdate(int, int, double, const double*, double*);
#endif /* defined(HAVE_BLAS) */
