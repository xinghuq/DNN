...
template <typename T>
void
DNN::internal::mlp_construct(const std::vector<int> &layers,
                              std::vector<int> &n_p,
...
template void DNN::internal::mlp_construct(const std::vector<int>&,
                                            std::vector<int>&,
...
template <typename T>
void
DNN::internal::mlp_expand_reorder_inputs(std::vector<int> &layers,
                                          std::vector<int> &n_p,
                                          std::vector<int> &n_prev,
                                          std::vector<int> &n_next,
                                          std::vector<int> &w_p,
...
// Explicit instantiations
#ifndef DNN_DOUBLE_ONLY
template void DNN::internal::mlp_expand_reorder_inputs(std::vector<int>&,
                                                        std::vector<int>&,
                                                        std::vector<int>&,
                                                        std::vector<int>&,
                                                        std::vector<int>&,
...
template <typename T>
int
DNN::internal::mlp_rm_neurons(std::vector<int> &layers,
                               std::vector<int> &n_p,
                               std::vector<int> &n_prev,
                               std::vector<int> &n_next,
                               std::vector<int> &w_p,
...
// Explicit instantiations
#ifndef DNN_DOUBLE_ONLY
template int DNN::internal::mlp_rm_neurons(std::vector<int>&, std::vector<int>&,
                                            std::vector<int>&, std::vector<int>&,
                                            std::vector<int>&, std::vector<float>&,
                                            std::vector<int>&, int&,
                                            std::vector<int>&, std::vector<float>&,
...
template <typename T>
void
DNN::internal::mlp_rm_input_neurons(std::vector<int> &layers,
                                     std::vector<int> &n_p,
                                     std::vector<int> &n_prev,
                                     std::vector<int> &n_next,
                                     std::vector<int> &w_p,
...
// Explicit instantiations
#ifndef DNN_DOUBLE_ONLY
template void DNN::internal::mlp_rm_input_neurons(std::vector<int>&, std::vector<int>&,
                                                   std::vector<int>&, std::vector<int>&,
                                                   std::vector<int>&, std::vector<float>&,
                                                   std::vector<int>&, bool);
#endif /* DNN_DOUBLE_ONLY */
...
template <typename T>
void
DNN::internal::mlp_merge(const std::vector<int> &Alayers,
...
template
void
DNN::internal::mlp_merge(const std::vector<int>&, const std::vector<int>&,
...
template <typename T>
void
DNN::internal::mlp_stack(const std::vector<int> &Alayers, const std::vector<int> &Aw_p,
...
template
void
DNN::internal::mlp_stack(const std::vector<int>&, const std::vector<int>&,
                          const std::vector<float>&, const std::vector<int>&,
                          const std::vector<int>&, const std::vector<int>&,
                          const std::vector<float>&, const std::vector<int>&,
                          std::vector<int>&, std::vector<int>&,
...
template <typename T>
bool
DNN::internal::mlp_save_txt(const std::string &fname,
                             ...
                             const std::vector<T> &af_p)
{
    ...
    file << "\n# DNN " << DNN_ver() << " network representation saved on "
         << time_str() << "\n\n";
...
template <typename T>
bool
DNN::internal::mlp_load_txt(const std::string &fname,
                             std::string &netname,
                             std::vector<int> &layers,
                             std::vector<int> &n_p,
                             std::vector<int> &n_prev,
...
// Explicit instantiations
#ifndef DNN_DOUBLE_ONLY
template bool DNN::internal::mlp_save_txt(const std::string&,
                                           const std::string&,
                                           ...
                                           const std::vector<int>&,
                                           const std::vector<float>&);
template bool DNN::internal::mlp_load_txt(const std::string&,
                                           std::string&,
                                           std::vector<int>&, std::vector<int>&,
                                           std::vector<int>&, std::vector<int>&,
                                           std::vector<int>&, std::vector<float>&,
...
void
DNN::internal::mlp_get_lnn_idx(const int *layers, const int *w_p,
...
int
DNN::internal::mlp_get_abs_w_idx(const int *w_fl, int i)
{
    int j = 0, k = 0;
...
template <typename T>
void
DNN::internal::mlp_set_active(const int *layers, const int *n_p,
...
// Explicit instantiations
#ifndef DNN_DOUBLE_ONLY
template void DNN::internal::mlp_set_active(const int*, const int*, int*, int*,
